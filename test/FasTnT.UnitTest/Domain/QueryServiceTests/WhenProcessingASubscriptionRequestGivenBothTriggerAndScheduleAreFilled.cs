...
{
    [TestClass]
    public class WhenProcessingASubscriptionRequestGivenBothTriggerAndScheduleAreFilled : BaseQueryServiceUnitTest
    {
        ...
        public override void Arrange()
        {
            ...
            Request = new Subscription { SubscriptionId = "TestSubscription", Trigger = "trigger", Schedule = new QuerySchedule(), Destination = "http://test.com/callback", QueryName = EpcisQueries.First(x => x.AllowSubscription).Name };
        ...
        [Assert]
        public void TheExceptionTypeShouldBeNoSubscribeNotPermittedException() => Assert.AreEqual(ExceptionType.SubscriptionControlsException, ((EpcisException)Catched).ExceptionType);
