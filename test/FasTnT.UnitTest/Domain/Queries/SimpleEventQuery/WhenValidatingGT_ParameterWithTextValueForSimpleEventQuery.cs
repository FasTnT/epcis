...
{
    [TestClass]
    public class WhenValidatingGT_ParameterWithTextValueForSimpleEventQuery : SimpleEventQueryParameterValidationFixture
    {
        public override void Arrange()
        {
            ...
            {
                new QueryParameter{ Name = "GT_eventTime", Values = new []{ "some text value" } }
            };
        }
