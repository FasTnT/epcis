...
{
    [TestClass]
    public class WhenValidatingmaxEventCountParameterWithMultipleValuesForSimpleEventQuery : SimpleEventQueryParameterValidationFixture
    {
        public override void Arrange()
        {
            ...
            {
                new QueryParameter{ Name = "maxEventCount", Values = new []{ "5", "10" } }
            };
        }
