...
{
    [TestClass]
    public class WhenValidatingGE_ParameterWithMultipleValuesForSimpleEventQuery : SimpleEventQueryParameterValidationFixture
    {
        public override void Arrange()
        {
            ...
            {
                new QueryParameter{ Name = "GE_eventTime", Values = new []{ "2019-05-01T10:02:54Z", "2019-05-01T11:02:54Z" } }
            };
        }
