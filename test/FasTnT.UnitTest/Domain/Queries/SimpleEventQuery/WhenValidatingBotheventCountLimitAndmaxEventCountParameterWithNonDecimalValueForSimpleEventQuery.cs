...
{
    [TestClass]
    public class WhenValidatingBotheventCountLimitAndmaxEventCountParameterWithNonDecimalValueForSimpleEventQuery : SimpleEventQueryParameterValidationFixture
    {
