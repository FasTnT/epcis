...
{
    [TestClass]
    public class WhenValidatingLT_ParameterWithTextValueForSimpleEventQuery : SimpleEventQueryParameterValidationFixture
    {
        public override void Arrange()
        {
            ...
            {
                new QueryParameter{ Name = "LT_eventTime", Values = new []{ "some text value" } }
            };
        }
