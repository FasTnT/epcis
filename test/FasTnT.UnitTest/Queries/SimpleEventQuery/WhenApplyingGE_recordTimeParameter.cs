...
{
    [TestClass]
    public class WhenApplyingGE_recordTimeParameter : SimpleEventQueryTestBase
    {
        public override void Given()
        {
            base.Given();

            Parameters.Add(new Model.Queries.QueryParameter { Name = "GE_recordTime", Values = new[] { "2018-04-01T10:21:10.521Z" } });
        }
