...
{
    [TestClass]
    public class WhenApplyingGT_INNER_ILMDParameterWithDateTimeValue : SimpleEventQueryTestBase
    {
        public override void Given()
        {
            base.Given();

            Parameters.Add(new Model.Queries.QueryParameter { Name = "GT_INNER_ILMD_namespace#ilmd", Values = new[] { "2019-08-24T10:05:02Z" } });
        }
