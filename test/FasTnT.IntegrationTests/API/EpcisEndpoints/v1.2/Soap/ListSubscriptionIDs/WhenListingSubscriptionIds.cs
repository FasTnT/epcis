...
namespace FasTnT.IntegrationTests.API.EpcisEndpoints.v1_2.Soap.ListSubscriptionIDs
{
    ...
    public class WhenListingSubscriptionIds : BaseIntegrationTest
    {
        public override void Act()
        {
            ...
            Result = Client.PostAsync("/v1_2/Query.svc", new StringContent(File.ReadAllText("Requests/Queries/ListSubscriptionIDs.xml"), Encoding.UTF8, "application/xml")).Result;
        }
