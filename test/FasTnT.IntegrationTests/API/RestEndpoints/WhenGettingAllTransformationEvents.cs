...
namespace FasTnT.IntegrationTests.API.RestEndpoints
{
    ...
    public class WhenGettingAllTransformationEvents : BaseMigratedIntegrationTest
    {
        public override void Act()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get, "/v1.2/events/TransformationEvent/all") { Content = new StringContent("", Encoding.UTF8, "application/json") };
