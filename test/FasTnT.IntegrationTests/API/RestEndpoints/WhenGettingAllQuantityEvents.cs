...
namespace FasTnT.IntegrationTests.API.RestEndpoints
{
    ...
    public class WhenGettingAllQuantityEvents : BaseMigratedIntegrationTest
    {
        public override void Act()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get, "/v2_0/events/QuantityEvent/all") { Content = new StringContent("", Encoding.UTF8, "application/json") };
