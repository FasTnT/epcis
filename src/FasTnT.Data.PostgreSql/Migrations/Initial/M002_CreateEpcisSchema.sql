...
(
    ...
    CONSTRAINT "PK_BUSINESS_TRANSACTION" PRIMARY KEY (event_id, request_id, transaction_type, transaction_id),
    CONSTRAINT "FK_BUSINESS_TRANSACTION_EVENT" FOREIGN KEY (event_id, request_id) REFERENCES epcis.event (id, request_id)
)
WITH (OIDS = FALSE);
...
(
    ...
    CONSTRAINT "PK_CUSTOMFIELD" PRIMARY KEY (event_id, request_id, field_id),
    CONSTRAINT "FK_CUSTOMFIELD_EVENT" FOREIGN KEY (event_id, request_id) REFERENCES epcis.event (id, request_id)
)
WITH (OIDS = FALSE);
...
(
    ...
    CONSTRAINT "PK_EPC" PRIMARY KEY (event_id, request_id, epc, type),
    CONSTRAINT "FK_EPC_EVENT" FOREIGN KEY (event_id, request_id) REFERENCES epcis.event (id, request_id)
)
WITH (OIDS = FALSE);
...
(
    ...
    CONSTRAINT "PK_SOURCE_DESTINATION" PRIMARY KEY (event_id, request_id, direction, type),
    CONSTRAINT "FK_SOURCE_DESTINATION_EVENT" FOREIGN KEY (event_id, request_id) REFERENCES epcis.event (id, request_id)
)
WITH (OIDS = FALSE);
